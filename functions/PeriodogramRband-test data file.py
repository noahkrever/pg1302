...
######################################################
    data=np.loadtxt('C:/Python27/Data/Swift_PG1302_Vband_data_2018.txt')
    print data
#    MJD=data[:,0]
#    mag=data[:,1]
#    magErr=data[:,2]
...
##    import h5py
##    filename='../QSO1000Iterations'+str(k)+'/QSO'+str(QSOId)+'_1000Iterations.h5'
...
##    #
##    #    Psim2,x=SimulateTimeSeriesDRW(BestFitTau,BestFitSigma,NumberOfPoints,ind,MJD,mag,magErr,omegaSlope,BestFitMean,N_bootstraps,deltat)
##
